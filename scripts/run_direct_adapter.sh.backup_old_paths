...
config_path="${TB4_CONFIG_PATH:-/home/masu_ubu/fleet_adapter_template_tb4_ws/src/tb4_fleet_adapter/config.yaml}"
nav_graph_path="${TB4_NAV_GRAPH_PATH:-/home/masu_ubu/rmf_main_ws/maps/tb4_rebuild_20260521/nav_graphs/0.yaml}"
dispatch_gate_file="${TB4_DISPATCH_GATE_FILE:-/tmp/tb4_manual_dispatch_enabled_robot2}"
